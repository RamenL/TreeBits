...
class BitModulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bit_module" do
    assert_difference('BitModule.count') do
      post bit_modules_url, params: { bit_module: { author: @bit_module.author, date_added: @bit_module.date_added, last_modified: @bit_module.last_modified, sub_topic_five: @bit_module.sub_topic_five, sub_topic_four: @bit_module.sub_topic_four, sub_topic_one: @bit_module.sub_topic_one, sub_topic_three: @bit_module.sub_topic_three, sub_topic_two: @bit_module.sub_topic_two } }
    end
  ...
  test "should update bit_module" do
    patch bit_module_url(@bit_module), params: { bit_module: { author: @bit_module.author, date_added: @bit_module.date_added, last_modified: @bit_module.last_modified, sub_topic_five: @bit_module.sub_topic_five, sub_topic_four: @bit_module.sub_topic_four, sub_topic_one: @bit_module.sub_topic_one, sub_topic_three: @bit_module.sub_topic_three, sub_topic_two: @bit_module.sub_topic_two } }
